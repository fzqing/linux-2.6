...
struct locking_rchan
{
	...
	raw_spinlock_t lock;		/* channel lock for locking scheme */
};
...
struct rchan
{
	...
	struct tasklet_queue_head work_tasklet;

	struct list_head open_readers;	/* open readers for this channel */
	raw_rwlock_t open_readers_lock;	/* protection for open_readers list */
