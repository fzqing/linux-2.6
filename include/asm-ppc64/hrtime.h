/*
 * include/asm-ppc64/hrtime.h
 *
 * PPC64 High-Res Timers header file
 *
 ...
 * or implied.
 */
#ifndef _ASMPPC64_HRTIME_H
#define _ASMPPC64_HRTIME_H

#ifdef __KERNEL__
#undef div_long_long_rem
...
static inline unsigned int scaled_mult(int x, int y, int shift) 
{
	int hi;
	unsigned lo;
