...
static int __init fixed_init(void)
{
	...
	*/
	...
	fixed_mdio_register_device(bus_number, 100, 1);	/* bus_id members of
						fs_platform_info structures has
						to be initialized in conformance
						with bus identifiers made by this
						function; look for example
						arch/ppc/platforms/mpc885ads_setup.c
						file. */
	bus_number++;
#endif

#ifdef CONFIG_FIXED_SECOND_MII_100_FDX
	fixed_mdio_register_device(bus_number, 100, 1);
	bus_number++;
#endif

#ifdef CONFIG_FIXED_MII_10_FDX
	fixed_mdio_register_device(bus_number, 10, 1);
#endif
	return 0;
}
