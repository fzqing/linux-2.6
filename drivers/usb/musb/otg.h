 ...
 * otg_input_changed has changed
 * @param musb musb_controller pointer
 * @param bIntrUSB controller interrupts
 * @param devctl   controller's status and control informtion
 * @param power    controller's power information
 * @see #otg_input_changed
 */
/* 21 SEPT 2006 HBG OTG Enhncement moving OTG related code to otg.c only*/
