...
#define XLR_MAX_HWIFS 1

/* Except for the PCMCIA Interface, avoid scanning for all
 * other IDE interfaces here. Do these PCI-based IDE scans
 * -after- the interfaces have been detected
 */
int xlr_ideprobe_init (void)
{
	unsigned int index;
	int probe[XLR_MAX_HWIFS];

	memset(probe, 0, XLR_MAX_HWIFS * sizeof(int));
	for (index = 0; index < XLR_MAX_HWIFS; ++index)
...
EXPORT_SYMBOL_GPL(xlr_ideprobe_init);
#endif
