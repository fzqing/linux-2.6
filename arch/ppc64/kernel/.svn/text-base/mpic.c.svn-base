				...
				const char *name)
{
	...
	mpic->hc_irq.startup = NULL;
	mpic->hc_irq.shutdown = NULL;
	mpic->hc_irq.enable = mpic_enable_irq;
	mpic->hc_irq.disable = mpic_disable_irq;
	mpic->hc_irq.ack = ack_none;
	mpic->hc_irq.end = mpic_end_irq;
	if (flags & MPIC_PRIMARY)
		mpic->hc_irq.set_affinity = mpic_set_affinity;
	else
		mpic->hc_irq.set_affinity = NULL;
#ifdef CONFIG_SMP
	mpic->hc_ipi.typename = name;
	mpic->hc_ipi.startup = NULL;
	mpic->hc_ipi.shutdown = NULL;
	mpic->hc_ipi.enable = mpic_enable_ipi;
	mpic->hc_ipi.disable = mpic_disable_ipi;
	mpic->hc_ipi.ack = ack_none;
	mpic->hc_ipi.end = mpic_end_ipi;
	mpic->hc_ipi.set_affinity = NULL;
#endif /* CONFIG_SMP */
