...
#ifdef CONFIG_NEC_VRBLADE
#define PCI_MASTER_IO_BUS_BASE_ADDRESS		0x17000000U
#define PCI_MASTER_IO_ADDRESS_MASK		0x7f000000U
#else
...
#ifdef CONFIG_NEC_VRBLADE
#define PCI_IO_RESOURCE_START	0x00000000UL
#define PCI_IO_RESOURCE_END	0x00ffffffUL
#else
